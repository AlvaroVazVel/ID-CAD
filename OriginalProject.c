       ...
       while (i5 = 1){  // PASO DERECHO
               while(i6 =0){//Pulso continuo no activo   
                    if (i1 != 1){//Microswitch reposo   
                        if(i7 == 1){//Bloqueo de salida activado o también el de entrada
                              martillo = 1; 
                              delay_ms (10000);
                              martillo = 0;
                        }   
                            ...
                            if (i2 == 1){//Microswitch giro derecho  
                                if (prevS == 0){ //Switch previo, detecta que ya pasó  o no por i3
                                    while(i2 == 1){//Mientras esté intentando entrar activa martillo  
                                       martillo = 1; 
                                       delay_ms (10000);
                                       martillo = 0;
                                    }
                     ...
                     if (i8==1){//MODO MULTIPULSO  
                         ...
                         if(i4 == 1){//Señal de paso
                           ...
                           for (i=0;i<numpasos;i++){ 
                                ...
                                while(TIFR0.TOV0==0){//mientras la bandera de overflow no sea 1 
                                    if(i1 == 0 && i3 == 1){
                                       while(i3 == 1){//Mientras esté intentando entrar activa martillo  
                                           martillo = 1; 
                                           delay_ms (10000);
                                           martillo = 0;
                                       }
